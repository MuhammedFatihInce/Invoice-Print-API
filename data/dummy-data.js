...
async function populate() {
    ...
    if(count == 0) { 
        ...
        await Invoice.bulkCreate([
            ...
            { userId: 2, invoiceDate: '2024-02-01', dueDate: '2024-02-15', paymentDate: '2024-02-14', amount: 200.00, taxRate: 18.00, status: true, description: 'Danışmanlık hizmetleri', invoicePath: "D:/CV.pdf", download:false  },
            ...
            { userId: 2, invoiceDate: '2024-07-01', dueDate: '2024-07-15', paymentDate: '2024-07-10', amount: 325.00, taxRate: 18.00, status: true, description: 'Düzenleme hizmetleri', invoicePath: "D:/CV.pdf", download:false  },
            ...
            { userId: 2, invoiceDate: '2024-12-01', dueDate: '2024-12-15', paymentDate: '2024-12-14', amount: 825.00, taxRate: 18.00, status: true, description: 'Web tasarım', invoicePath: "D:/CV.pdf", download:false  },
            ...
            { userId: 2, invoiceDate: '2025-05-01', dueDate: '2025-05-15', paymentDate: '2025-05-10', amount: 1325.00, taxRate: 18.00, status: true, description: 'Sosyal medya yönetimi', invoicePath: "D:/CV.pdf", download:false  },
            ...
            { userId: 2, invoiceDate: '2025-10-01', dueDate: '2025-10-15', paymentDate: '2025-10-10', amount: 1825.00, taxRate: 18.00, status: true, description: 'Yazılım testi', invoicePath: "D:/CV.pdf", download:false  },
        ...
        await Printer.create({Name: "HP Printer",	PortNumber: "800", HostAddress: "127.0.0.1", Status: false
        });
    }    
